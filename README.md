# ⚡ ESP32 High-Rate GPS/GNSS Fleet Blackbox & Inertial Dead Reckoning
...
Vehicle blackbox combining 10Hz GNSS NMEA receiver, 6-axis IMU dead reckoning, SD card circular buffer logging, and crash G-force incident capture.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-gps-telematics-blackbox.ino`](./esp32-gps-telematics-blackbox.ino).
